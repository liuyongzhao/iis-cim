...
@Data
@Entity
@Table(name="Operationphysicalassetsegmentspecificationproperty")
@DynamicInsert
@DynamicUpdate
public class OperationphysicalassetsegmentspecificationpropertyEntity implements Serializable {
    @Id
    ...
    private String physicalAssetPropertyTagId;
    @Column(nullable = false, length = 45)
    private String physicalAssetPropetyId;
    @Column(nullable = false, length = 45)
