...
@Data
@Entity
@Table(name="Processsegmentmaterialspecificationproperty")
@DynamicInsert
@DynamicUpdate
public class ProcesssegmentmaterialspecificationpropertyEntity implements Serializable {
        @Id
        @GeneratedValue(strategy = GenerationType.IDENTITY)
        @Column
        private Integer id;
        @Column(nullable = false)
        private Integer materialSegmentId;
        @Column(nullable = false)
