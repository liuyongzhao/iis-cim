...
@Data
@Entity
@Table(name="Processsegmentequipmentspecificationproperty")
@DynamicInsert
@DynamicUpdate
public class ProcesssegmentequipmentspecificationpropertyEntity implements Serializable {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column
    private Integer id;
    @Column(nullable = false)
    private Integer equipmentSegmentId;
    @Column(nullable = false)
