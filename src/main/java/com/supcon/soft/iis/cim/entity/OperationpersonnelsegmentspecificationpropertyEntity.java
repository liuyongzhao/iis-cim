...
@Data
@Entity
@Table(name="Operationpersonnelsegmentspecificationproperty")
@DynamicInsert
@DynamicUpdate
public class OperationpersonnelsegmentspecificationpropertyEntity implements Serializable {
    @Id
    ...
    private String personnelPropertyTagId;
    @Column(nullable = false, length = 45)
    private String personnelPropetyId;
    @Column(nullable = false, length = 45)
