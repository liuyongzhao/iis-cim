...
@Data
@Entity
@Table(name="Operationequipmentsegmentspecificationproperty")
@DynamicInsert
@DynamicUpdate
public class OperationequipmentsegmentspecificationpropertyEntity implements Serializable {
    @Id
    ...
    private String equipmentPropertyTagId;
    @Column(nullable = false, length = 45)
    private String equipmentPropertyId;
    @Column(nullable = false, length = 45)
